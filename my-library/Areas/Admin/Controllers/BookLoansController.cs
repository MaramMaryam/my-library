...
namespace my_library.Areas.Admin.Controllers
{
    public class BookLoansController : Controller
    {
        ...
        {
            var bookLoan = db.BookLoan.Include(b => b.PageGroups).Include(b => b.Pages);
        ...
        public ActionResult Create([Bind(Include = "BookLoanID,PageID,GroupID,UserID,LoanFrom,LoanUntill")] BookLoan bookLoan)
        {
            ...
            ViewBag.GroupID = new SelectList(db.PageGroups, "GroupID", "GroupTitle", bookLoan.GroupID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookLoanID,PageID,GroupID,UserID,LoanFrom,LoanUntill")] BookLoan bookLoan)
        {
            if (ModelState.IsValid)
            {
